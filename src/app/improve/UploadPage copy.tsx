      ...
      <div className="min-h-screen bg-zinc-50 text-zinc-900 flex flex-col items-center justify-center p-6 pb-20 selection:bg-teal-500/30">
        ...
        <div className="mb-12">
            <Link to="/" className="flex items-center gap-2 group">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-teal-600 shadow-lg group-hover:scale-105 transition-transform">
                    <span className="text-white font-bold text-lg tracking-tight">RX</span>
                </div>
                <span className="font-extrabold text-3xl tracking-tight text-zinc-900">
                    ROZGAR <span className="font-extrabold text-teal-600">24X7</span>
                </span>
            </Link>
        </div>
        ...
        <header className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl border-b border-zinc-200 px-4 sm:px-8 lg:px-12 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4 w-full">
            {company.slug === 'for_all' ? (
                <Link to="/" className="flex items-center gap-2 group">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600 to-teal-600 shadow-md group-hover:scale-105 transition-transform">
                        <span className="text-white font-bold text-xs tracking-tight">RX</span>
                    </div>
                    <span className="font-bold text-xl tracking-tight text-zinc-900">
                        ROZGAR <span className="font-bold text-teal-600">24X7</span>
                    </span>
                </Link>
