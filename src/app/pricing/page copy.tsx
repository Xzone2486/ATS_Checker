  ...
  const startAnalysis = async () => {
    ...
    try {
      const result = await analyzeAts({
        resumeFile: file,
        jdText: customJd.trim() || undefined,
        targetRole: jobRole.trim() || undefined,
      })
              ...
              >
                <div className="text-center max-w-3xl mb-12 mx-auto">
                  ...
                  <p className="text-muted-foreground">
                    Choose a plan to enhance your resume and increase your chances.
                  </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto w-full perspective-1000">
                   {plans.map((plan, i) => (
                     <motion.div 
                       key={plan.name}
